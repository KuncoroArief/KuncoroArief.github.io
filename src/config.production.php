...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MSSQL", "qs" => "[", "qe" => "]", "host" => "103.13.120.109", "port" => "1533", "user" => "sa", "password" => "n0N5Q8@vPCr5(l", "dbname" => "v200101_demos"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "qU1ImkU76T4hNTPC", // API Secret Key
