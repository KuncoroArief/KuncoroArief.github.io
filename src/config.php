...
$CONFIG = [
    ...
    "RANDOM_KEY" => '6hXFVH6MQ2KP10dR', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/tooms.css", // Project stylesheet file name
    ...
    "USER_TABLE_NAME" => "cf_user",
    "LOGIN_USERNAME_FIELD_NAME" => "empl_id",
    ...
    // User table filters
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "[dbo].[cf_user]",
    "USER_NAME_FILTER" => "([empl_id] = '%u')",
    "USER_ID_FILTER" => "",
    "USER_EMAIL_FILTER" => "",
