 ...
 * Page class
 */
class CfUserAdd extends CfUser
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CfUserView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->empl_id->OldValue = $this->empl_id->CurrentValue;
        $this->name->CurrentValue = null;
        $this->name->OldValue = $this->name->CurrentValue;
        $this->default_site->CurrentValue = null;
        $this->default_site->OldValue = $this->default_site->CurrentValue;
        $this->default_language->CurrentValue = null;
        $this->default_language->OldValue = $this->default_language->CurrentValue;
        $this->sys_admin->CurrentValue = null;
        $this->sys_admin->OldValue = $this->sys_admin->CurrentValue;
        $this->status->CurrentValue = null;
        $this->status->OldValue = $this->status->CurrentValue;
        $this->supv_empl_id->CurrentValue = null;
        $this->supv_empl_id->OldValue = $this->supv_empl_id->CurrentValue;
        $this->shift->CurrentValue = null;
        $this->shift->OldValue = $this->shift->CurrentValue;
        $this->work_area->CurrentValue = null;
        $this->work_area->OldValue = $this->work_area->CurrentValue;
        $this->work_grp->CurrentValue = null;
        $this->work_grp->OldValue = $this->work_grp->CurrentValue;
        $this->last_login_site->CurrentValue = null;
        $this->last_login_site->OldValue = $this->last_login_site->CurrentValue;
        $this->last_login->CurrentValue = null;
        $this->last_login->OldValue = $this->last_login->CurrentValue;
        $this->last_pwd_changed->CurrentValue = null;
        $this->last_pwd_changed->OldValue = $this->last_pwd_changed->CurrentValue;
        $this->audit_user->CurrentValue = null;
        $this->audit_user->OldValue = $this->audit_user->CurrentValue;
        $this->audit_date->CurrentValue = null;
        $this->audit_date->OldValue = $this->audit_date->CurrentValue;
        ...
        $this->column1->CurrentValue = null;
        $this->column1->OldValue = $this->column1->CurrentValue;
        $this->column2->CurrentValue = null;
        $this->column2->OldValue = $this->column2->CurrentValue;
        $this->column3->CurrentValue = null;
        $this->column3->OldValue = $this->column3->CurrentValue;
        $this->column4->CurrentValue = null;
        $this->column4->OldValue = $this->column4->CurrentValue;
        $this->column5->CurrentValue = null;
        $this->column5->OldValue = $this->column5->CurrentValue;
        $this->cf_user_failed_attempt->CurrentValue = null;
        $this->cf_user_failed_attempt->OldValue = $this->cf_user_failed_attempt->CurrentValue;
        $this->cf_user_locked->CurrentValue = null;
        $this->cf_user_locked->OldValue = $this->cf_user_locked->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['empl_id'] = $this->empl_id->CurrentValue;
        $row['name'] = $this->name->CurrentValue;
        $row['default_site'] = $this->default_site->CurrentValue;
        $row['default_language'] = $this->default_language->CurrentValue;
        $row['sys_admin'] = $this->sys_admin->CurrentValue;
        $row['status'] = $this->status->CurrentValue;
        $row['supv_empl_id'] = $this->supv_empl_id->CurrentValue;
        $row['shift'] = $this->shift->CurrentValue;
        $row['work_area'] = $this->work_area->CurrentValue;
        $row['work_grp'] = $this->work_grp->CurrentValue;
        $row['last_login_site'] = $this->last_login_site->CurrentValue;
        $row['last_login'] = $this->last_login->CurrentValue;
        $row['last_pwd_changed'] = $this->last_pwd_changed->CurrentValue;
        $row['audit_user'] = $this->audit_user->CurrentValue;
        $row['audit_date'] = $this->audit_date->CurrentValue;
        $row['RowID'] = $this->RowID->CurrentValue;
        $row['expired_date'] = $this->expired_date->CurrentValue;
        $row['column1'] = $this->column1->CurrentValue;
        $row['column2'] = $this->column2->CurrentValue;
        $row['column3'] = $this->column3->CurrentValue;
        $row['column4'] = $this->column4->CurrentValue;
        $row['column5'] = $this->column5->CurrentValue;
        $row['cf_user_failed_attempt'] = $this->cf_user_failed_attempt->CurrentValue;
        $row['cf_user_locked'] = $this->cf_user_locked->CurrentValue;
    ...
    {
        global $Language, $Security;
        if ($this->empl_id->CurrentValue != "") { // Check field with unique index
            $filter = "([empl_id] = '" . AdjustSql($this->empl_id->CurrentValue, $this->Dbid) . "')";
            $rsChk = $this->loadRs($filter)->fetch();
            if ($rsChk !== false) {
                $idxErrMsg = str_replace("%f", $this->empl_id->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->empl_id->CurrentValue, $idxErrMsg);
        ...
        // empl_id
        $this->empl_id->setDbValueDef($rsnew, $this->empl_id->CurrentValue, "", false);

        // name
        $this->name->setDbValueDef($rsnew, $this->name->CurrentValue, null, false);

        // default_site
        $this->default_site->setDbValueDef($rsnew, $this->default_site->CurrentValue, null, false);

        // default_language
        $this->default_language->setDbValueDef($rsnew, $this->default_language->CurrentValue, null, false);

        // sys_admin
        $this->sys_admin->setDbValueDef($rsnew, $this->sys_admin->CurrentValue, null, false);

        // status
        $this->status->setDbValueDef($rsnew, $this->status->CurrentValue, null, false);

        // supv_empl_id
        $this->supv_empl_id->setDbValueDef($rsnew, $this->supv_empl_id->CurrentValue, null, false);

        // shift
        $this->shift->setDbValueDef($rsnew, $this->shift->CurrentValue, null, false);

        // work_area
        $this->work_area->setDbValueDef($rsnew, $this->work_area->CurrentValue, null, false);

        // work_grp
        $this->work_grp->setDbValueDef($rsnew, $this->work_grp->CurrentValue, null, false);

        // last_login_site
        $this->last_login_site->setDbValueDef($rsnew, $this->last_login_site->CurrentValue, null, false);

        // last_login
        $this->last_login->setDbValueDef($rsnew, UnFormatDateTime($this->last_login->CurrentValue, 0), null, false);

        // last_pwd_changed
        $this->last_pwd_changed->setDbValueDef($rsnew, UnFormatDateTime($this->last_pwd_changed->CurrentValue, 0), null, false);

        // audit_user
        $this->audit_user->setDbValueDef($rsnew, $this->audit_user->CurrentValue, null, false);

        // audit_date
        $this->audit_date->setDbValueDef($rsnew, UnFormatDateTime($this->audit_date->CurrentValue, 0), null, false);

        // expired_date
        $this->expired_date->setDbValueDef($rsnew, UnFormatDateTime($this->expired_date->CurrentValue, 0), null, false);

        // column1
        $this->column1->setDbValueDef($rsnew, $this->column1->CurrentValue, null, false);

        // column2
        $this->column2->setDbValueDef($rsnew, $this->column2->CurrentValue, null, false);

        // column3
        $this->column3->setDbValueDef($rsnew, $this->column3->CurrentValue, null, false);

        // column4
        $this->column4->setDbValueDef($rsnew, $this->column4->CurrentValue, null, false);

        // column5
        $this->column5->setDbValueDef($rsnew, $this->column5->CurrentValue, null, false);

        // cf_user_failed_attempt
        $this->cf_user_failed_attempt->setDbValueDef($rsnew, $this->cf_user_failed_attempt->CurrentValue, null, false);

        // cf_user_locked
        $this->cf_user_locked->setDbValueDef($rsnew, $this->cf_user_locked->CurrentValue, null, false);

        // password
        $this->_password->setDbValueDef($rsnew, $this->_password->CurrentValue, null, false);

        // user_password
        $this->user_password->setDbValueDef($rsnew, $this->user_password->CurrentValue, null, false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['empl_id']) == "") {
